...
double DemandForces(double K,double Fmax);
...
int w2Visits_ = 0;
const int maxW2Visits_ = 1;
bool cycleComplete_ = false;

Eigen::Vector2d x_opt_plot_ = Eigen::Vector2d::Zero();

Eigen::Vector3d v_obj = Eigen::Vector3d::Zero();
Eigen::Vector3d a_obj = Eigen::Vector3d::Zero();


bool waitingAtWaypoint_ = false;
double waypointDwellTimer_ = 0.0;
double waypointDwellDuration_ = 8.0;
