...
private:
  ...
  Eigen::Vector3d objectPosError_ = Eigen::Vector3d::Zero();
  double objectOriError_ = 0.0;
  Eigen::Vector6d leftForceError_ = Eigen::Vector6d::Zero();
  Eigen::Vector6d rightForceError_ = Eigen::Vector6d::Zero();

  bool logsRegistered_ = false;
};
